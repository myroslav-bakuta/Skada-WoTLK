...
L["opt_tweaks_minattemptdps_desc"] = "Какой урон в секунду должен набрать пулл, чтобы считаться настоящей попыткой, достойной сохранения. Питомец, забредший к боссу, или босс, сразу ушедший в эвейд, оставляют сегмент с именем босса и почти без данных."
L["opt_tweaks_minattemptdps_note"] = "\n|cffffbb00Внимание:|r убийство сохраняется всегда, независимо от урона, а пулл, в котором группа так и не вступила в бой, не сохраняется никогда. Ноль оставляет только эту проверку."
