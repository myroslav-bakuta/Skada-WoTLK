...
L["opt_tweaks_minattemptdps_note"] = "\n|cffffbb00Внимание:|r убийство сохраняется всегда, независимо от нанесённого урона, а пулл, в котором рейд так и не вступил в бой, не сохраняется никогда. Ноль оставляет только эту проверку."
