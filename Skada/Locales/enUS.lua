...
L["opt_tweaks_combatgrace_desc"] = "How long the whole group has to stay out of combat before the fight counts as over.\nCombat flags flicker between trash packs, and a single quiet moment used to chop one pull into several segments."
L["opt_tweaks_combatgrace_slider_desc"] = "Seconds of quiet before the segment ends. Zero ends it at the first quiet moment."
L["opt_tweaks_stalecombat_warn"] = "|cffffbb00Note:|r this cannot go below %d seconds, the value set in \"%s\". Raising that one raises this along with it."
L["Debug Log"] = true
L["Verbose"] = true
L["Clear"] = true
