...
L["Stuck Combat Guard"] = "Защита от зависшего боя"
L["opt_tweaks_stalecombat_desc"] = "Клиент может надолго оставить участника группы в режиме боя, когда всё уже мертво, и сегмент не заканчивается."
L["Idle Time"] = "Время простоя"
L["opt_tweaks_stalecombattime_desc"] = "Сколько боевой журнал должен молчать, пока вы вне боя, прежде чем сегмент будет завершён?"
L["Segment End Delay"] = "Задержка завершения сегмента"
L["opt_tweaks_combatgrace_desc"] = "Сколько времени вся группа должна пробыть вне боя, прежде чем бой считается завершённым."
L["opt_tweaks_combatgrace_slider_desc"] = "Секунды тишины до завершения сегмента. Ноль завершает его на первом же тихом мгновении."
L["opt_tweaks_stalecombat_warn"] = "\n|cffffbb00Внимание:|r значение не может быть меньше %d с, заданных в разделе \"%s\". Если поднять то значение, это поднимется вместе с ним."
L["Stopped Segment Timeout"] = "Тайм-аут остановленного сегмента"
L["opt_tweaks_autostopclose_desc"] = "Сегмент, замороженный после смерти босса, ничего не записывает, поэтому он закрывается по таймеру, а не ждёт выхода группы из боя."
L["opt_tweaks_autostopclose_slider_desc"] = "Сколько секунд ждать перед закрытием сегмента, остановленного автоматически."
L["opt_tweaks_autostopclose_note"] = "\n|cffffbb00Внимание:|r сегмент, остановленный вами вручную, так не закрывается и ждёт возобновления."
L["Split Late Boss Pulls"] = "Разделять поздние пуллы боссов"
L["Trash Time"] = "Время на трэш"
L["opt_tweaks_bosssplit_desc"] = "Зачистка трэша, перетекающая в босса, раньше отдавала боссу весь этот трэш, что растягивает бой и занижает показатели всех участников. Если сегмент уже некоторое время идёт по другим целям и только затем появляется босс, Skada закроет тот сегмент и откроет боссу собственный, чистый."
L["opt_tweaks_bosssplittime_desc"] = "Сколько сегмент должен идти по другим целям, прежде чем босс получит собственный сегмент."
L["opt_tweaks_bosssplit_note"] = "\n|cffffbb00Внимание:|r разделяется только сегмент, начатый на других целях, поэтому босс, которого вы пуллите сразу, всегда сохраняет свой сегмент."
L["Drop Failed Attempts"] = "Удалять неудачные попытки"
L["opt_tweaks_dropwipes_desc"] = "Неудачные попытки на боссе сохраняются так же, как и убийство, и остаются, пока вы их не удалите. Включите, чтобы успешное убийство удаляло неудачные предыдущие попытки на том же боссе."
L["opt_tweaks_dropwipes_note"] = "\n|cffffbb00Внимание:|r освобождённый сегмент не удаляется сразу, он лишь теряет закреплённое место и вытесняется как любой другой, когда список заполнен. Освобождаются только попытки на убитом боссе. Требуется \"%s\"."
L["Minimum Attempt DPS"] = "Минимальный урон в секунду для попытки"
L["opt_tweaks_minattemptdps_desc"] = "Какой урон в секунду должен нанести рейд, чтобы пулл считался настоящей попыткой, достойной сохранения сегмента. Пет, запуливший босса, или босс, сразу ушедший в эвейд, оставляют сегмент с именем босса и почти без данных."
L["opt_tweaks_minattemptdps_note"] = "\n|cffffbb00Внимание:|r убийство сохраняется всегда, независимо от нанесённого урона. Ноль отключает эту проверку урона, оставляя только другое правило: пулл, в котором рейд так и не вступил в бой, не сохраняется никогда."
L["Name Segments By Main Enemy"] = "Название сегмента для трэш-пака"
L["opt_tweaks_trashrename_desc"] = "Сегмент получает имя первого моба, попавшего в боевой журнал (в рейде это часто обычный моб из трэш-пака). С этой настройкой сегмент называется именем моба, с которым рейд действительно сражался, а не именем босса."
L["opt_tweaks_trashrename_note"] = "\n|cffffbb00Внимание:|r бои с боссами уже имеют корректное название и никогда не переименовываются."
L["Debug Log"] = "Журнал диагностики"
L["Verbose"] = "Подробно"
L["Clear"] = "Очистить"
L["opt_tweaks_debuglog_desc"] = "Записывает, что Skada решает о сегментах, боссах, составе группы и питомцах.\nНужен, чтобы сообщить о проблеме: включите, поиграйте, затем перезагрузите интерфейс."
L["opt_tweaks_debuglog_enable_desc"] = "Начать запись."
L["opt_tweaks_debuglog_verbose_desc"] = "Дополнительно записывать сырые события боевого журнала в начале каждого сегмента. Объём намного больше, включайте на один бой, а не на целый рейд."
L["opt_tweaks_debuglog_clear_desc"] = "Отбросить всё записанное и начать новую сессию."
L["opt_tweaks_debuglog_status"] = "Запись: %s      Подробно: %s      Строк: %d      Сессий: %d"
L["opt_tweaks_debuglog_help"] = "\nЖурнал хранится в памяти и попадает в файл сохранённых переменных только при перезагрузке интерфейса или выходе из игры.\nХранятся последние 3 сессии, до 50000 строк каждая, чего хватает на целый рейдовый вечер.\nКоманды: /skada log on | verbose | off | clear"
...
L["Kologarn"] = "Кологарн"
L["Mimiron"] = "Мимирон"
L["Skarvald and Dalronn"] = "Скарвальд и Далронн"
L["Thaddius"] = "Таддиус"
