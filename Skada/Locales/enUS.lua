...
L["opt_tweaks_minattemptdps_desc"] = "The damage per second a pull has to reach before it counts as a real attempt worth saving. A pet that wandered into a boss, or a boss that evaded at once, leaves a segment carrying the boss name and almost nothing else."
L["opt_tweaks_minattemptdps_note"] = "\n|cffffbb00Note:|r a kill is always saved, whatever its damage, and a pull the group never entered combat for is never saved. Set to zero to judge attempts by that alone."
L["Debug Log"] = true
L["Verbose"] = true
L["Clear"] = true
