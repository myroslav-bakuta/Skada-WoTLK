...
L["Trash Time"] = true
L["opt_tweaks_bosssplit_desc"] = "A trash pull that runs into a boss used to hand the boss all of that trash, which stretches the fight and drags everyone's numbers down."
...
L["opt_tweaks_bosssplit_note"] = "\n|cffffbb00Note:|r creatures that belong to a fight are known by Skada, so a boss phase fought on adds is never split off."
L["Debug Log"] = true
L["Verbose"] = true
L["Clear"] = true
