...
L["opt_tweaks_bosssplit_desc"] = "Зачистка трэша, перетекающая в босса, раньше отдавала боссу весь этот трэш, что растягивает бой и занижает показатели всех участников."
L["opt_tweaks_bosssplittime_desc"] = "Сколько сегмент должен идти по другим целям, прежде чем босс получит собственный сегмент."
L["opt_tweaks_bosssplit_note"] = "\n|cffffbb00Внимание:|r существа, относящиеся к бою, известны Skada, поэтому фаза босса на прислужниках никогда не отделяется."
