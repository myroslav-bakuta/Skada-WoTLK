...
L["Keep Failed Attempts"] = "Сохранять неудачные попытки"
L["opt_tweaks_keepwipes_desc"] = "Успешное убийство босса отменяет хранение неудачных предыдущих попыток, тем самым список сегментов не засоряется ненужными записями. Включите, чтобы вместо этого сохранять каждую попытку."
L["opt_tweaks_keepwipes_note"] = "\n|cffffbb00Внимание:|r сохранённые сегменты занимают место, пока вы их не удалите, поэтому большое количество вайпов может заполнить список сегментов. Требуется \"%s\"."
